...
export const CHECKBOXES = [
  "Pregnant", "Disabled", "Veteran", "LGBTQ", "Farm Worker", "Older Adult (over 65)"
]

export const DEMOGRAPHIC_GROUPS = [
  "African American/Black", "Immigrant", "Arab American", "Jewish", "Latino/Hispanic", "Native American/Indigenous", "Asian American", "Other (please specify below)"
]
